...
export const Profile: React.FC = () => {
  ...
  useEffect(() => {
    // Track page view
    analytics.trackPageView(location.pathname, 'Profile - User Dashboard');
    analytics.trackEngagement('profile_view');
  }, [location.pathname]);
